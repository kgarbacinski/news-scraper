...
def generate_token(credentials_login: str, credentials_password: str):
    if (credentials_login == config('CREDENTIALS_LOGIN', os.environ['CREDENTIALS_PASSWORD']) 
    and credentials_password == config('CREDENTIALS_LOGIN', os.environ['CREDENTIALS_PASSWORD'])):
